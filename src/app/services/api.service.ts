...
async getVentaById(id: number): Promise<{
        ...
        const datos = (await axiosService.get(`${config.urls.getVentas}/${id}`))
            .data;
        return {
            nroVenta: datos.id,
            fecha: datos.fecha,
    ...
    async getPeliculaById(id: number): Promise<{
        ...
        const datos = (await axiosService.get(`${config.urls.getPeliculas}/${id}`))
            .data;
        return {
            id:datos.id,
            titulo:datos.titulo,
        ...
        async getTiposDni():Promise< 
        Array<{ id:number; 
            denominacion: string;}>
        > { const datos = (await axiosService.get(config.urls.getTiposDni,{
    ...
    async deleteTipoDni(id: number): Promise<void> {
       ...
       async getTiposCliente():Promise< 
        Array<{ id:number; 
            nombre: string;}>
        > { const datos = (await axiosService.get(config.urls.getTiposCliente,{
    ...
    async deleteTipoCliente(id: number): Promise<void> {
       ...
       async getEstadosPeliculas():Promise< 
        Array<{ id:number; 
            nombre: string;}>
        > { const datos = (await axiosService.get(config.urls.getEstadosPeliculas,{
    ...
    async deleteEstadoPelicula(id: number): Promise<void> {
      ...
      async getPromociones():Promise< 
        ...
        > { const datos = (await axiosService.get(config.urls.getPromociones,{
     ...
     async deletePromocion(id: number): Promise<void> {
      ...
      async getVentas():Promise< 
        Array<{ nroVenta: number;
            fecha: Date;
            hora: Date;
            total: number;
            promocionId?: number;
        }>
        > { const datos = (await axiosService.get(config.urls.getVentas,{
    ...
    async getPeliculas():Promise< 
        ...
        > { const datos = (await axiosService.get(config.urls.getPeliculas,{
     ...
     async getEntradas():Promise< 
        Array<{ id:number; 
            codigoSeguridad: string;}>
        > { const datos = (await axiosService.get(config.urls.getEntradas,{
